<script>
    ...
    function get_question() {
        fastapi("get", "/api/rquestion/detail/" + question_id, {}, (json) => {
            question = json
        })
    }
    ...
    function post_answer(event) {
        ...
        let url = "/api/ranswer/create/" + question_id
        let params = {
            content: content
        }
    ...
    <div class="card my-3">
        <div class="card-body">
            ...
            <div class="my-3">
                ...
                <a use:link href="/recommend-diet-modify/{question.id}"
